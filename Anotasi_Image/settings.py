...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'Anotasi_Image' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Database — SQLite (tidak perlu install PostgreSQL)
DATABASES = {
    'default': {
...
# Email (nonaktif untuk development)
...
# Port info (tidak dipakai Django, hanya referensi)
USER_PORT = 8000
ADMIN_PORT = 8001